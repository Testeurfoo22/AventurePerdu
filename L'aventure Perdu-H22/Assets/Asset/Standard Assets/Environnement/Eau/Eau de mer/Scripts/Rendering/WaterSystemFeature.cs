...
#if UNITY_EDITOR
      causticTexture = UnityEditor.AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Standard Assets/Environnement/Eau/Eau De Mer/Textures/WaterSurface_single.tif");
#endif
    }
